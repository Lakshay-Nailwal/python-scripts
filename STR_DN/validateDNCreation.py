...
INPUT_CSV = "/Users/lakshay.nailwal/Desktop/updatedScripts/STR_DN/CSV_FILES/GDN_ret_CN_null_mercury_pending.csv"
...
def process_csv():
    ...
    if( data ):
        save_to_csv("str_dn_validation_v4.csv" , ['invoice_id' , 'invoice_no' , 'tenant'] , data , OUTPUT_DIR)
